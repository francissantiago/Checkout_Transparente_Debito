            ...
            <div class="row mt-2 mb-2">
                ...
                <div class="col-md-6">
                    <label for="input_orderType">Tipo de Pagamento:</label>
                        <input type="text" class="form-control" id="input_orderType" name="input_orderType" value="DEBIT" readonly required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-md-4">
...
<script src="<?php $localPath;?>/assets/js/createSession.js"></script>
<!-- Criação de ordem de pagamento e autenticação 3DS -->
<script src="<?php $localPath;?>/assets/js/generateOrder.js"></script>
<!-- Scripts JS para pagamento com cartão de débito -->
